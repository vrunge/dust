...
public:
  Bern_MD(std::string dualmax_algo, std::string constr_index, Nullable<unsigned> nbLoops = Nullable<unsigned>());
protected:
  ...
  std::array<double, 2> muInterval(const arma::colvec& a, const arma::colvec& b, double& c, double& ) const override;
