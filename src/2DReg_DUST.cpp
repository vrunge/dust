...
// --- // Constructor // --- //
DUST_Reg::DUST_Reg(std::string dualmax_algo,
...
void DUST_Reg::pruning_method()
{
  ...
  /// /// /// dualmax_algo METHOD
  /// /// ///
  if(dualmax_algo == "DUSTr"){current_test = &DUST_Reg::dualMaxAlgoRand;}
  if(dualmax_algo == "PELT"){current_test = &DUST_Reg::dualMaxPelt;}
  if(dualmax_algo == "OP"){current_test = &DUST_Reg::dualOP;}
  if(dualmax_algo == "DUST1"){current_test = &DUST_Reg::decisionTest1;}
  if(dualmax_algo == "DUST2"){current_test = &DUST_Reg::decisionTest2;}
...
void DUST_Reg::append_data(std::vector<double>& inData, Nullable<double> inPenalty)
{
...
void DUST_Reg::update_partition()
{
...
List DUST_Reg::dust(std::vector<double>& inData, Nullable<double> inPenalty)
{
...
bool DUST_Reg::dualMaxAlgoRand(double minCost_t,
                           unsigned int t,
                           unsigned int s,
                           unsigned int r1,
                           unsigned int r2)
...
bool DUST_Reg::dualOP(double minCost_t,
                          unsigned int t,
                          unsigned int s,
                          unsigned int r1,
                          unsigned int r2)
...
bool DUST_Reg::dualMaxPelt(double minCost_t,
                              unsigned int t,
                              unsigned int s,
                              unsigned int r1,
                              unsigned int r2)
...
bool DUST_Reg::decisionTest1(double minCost_t,
                                 unsigned int t,
                                 unsigned int s,
                                 unsigned int r1,
                                 unsigned int r2)
...
bool DUST_Reg::decisionTest2(double minCost_t,
                                 unsigned int t,
                                 unsigned int s,
                                 unsigned int r1,
                                 unsigned int r2)
...
double DUST_Reg::costEval(double point1, double point2, unsigned int t, unsigned int s)
{
  return - point1*point1/(4.0*point2) + 0.5*std::log(-1.0/(2.0*point2))
  - point1 *(cumsum[t] - cumsum[s]) - point2 * (cumsum2[t] - cumsum2[s]);
}

double DUST_Reg::costMin(unsigned int t, unsigned int s)
{
...
double DUST_Reg::decisionEval1(double point,
                                   double minCost_t,
                                   unsigned int t,
                                   unsigned int s,
                                   unsigned int r)
...
double DUST_Reg::decisionEval2(double point1,
                                   double point2,
                                   double minCost_t,
                                   unsigned int t,
                                   unsigned int s,
...
double DUST_Reg::dualEval(double point,
                              double minCost,
                              unsigned int t,
                              unsigned int s,
                              unsigned int r)
...
double DUST_Reg::dualMax(double minCost_t, unsigned int t, unsigned int s, unsigned int r)
{
  return 0;
}
...
double DUST_Reg::muMax(double a, double b, double a2, double b2)
{
  double Va = a2 - std::pow(a, 2);
  double Vb = b2 - std::pow(b, 2);
...
double DUST_Reg::xMax(double a, double b)
{
